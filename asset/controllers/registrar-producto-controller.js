...
function registrarProducto(e) {
    ...
    const link = "./producto_visualizacion.html";
    const numeroAleatorio = Math.floor(Math.random() * 40)
    inputURLImagen.value = `./asset/img/productos-${numeroAleatorio}.png`;
...
function mostrar() {
    ...
    if (archivo.size < tamañoMaximo) {
        ...
        inputURLImagen.value = `../asset/img/productos/${archivo.name}`;
