...
function mostrarTodo(id, nombre, precio, imagen, categoria, link, descripcion) {
    ...
    const contenido = `
    <div>
        <img src="${imagen}" alt="producto Pokemon" class="producto_img" >
...
productosServicios.listaProductos()
    .then(resultado => {
        resultado.forEach(({ id, nombre, precio, imagen, categoria, link, descripcion }) => {
            const verTodo = mostrarTodo(id, nombre, precio, imagen, categoria, link, descripcion);
        ...
        try {
            ...
            for (let producto of productos) {
                ...
                if (nombre.indexOf(texto) !== -1) {
                    ...
                    const resultado = mostrarResultadoBusqueda(id, nombre, precio, imagen, link, descripcion);
